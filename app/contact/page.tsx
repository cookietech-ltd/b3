                ...
                <div className="container-custom grid md:grid-cols-2 gap-20">
                    ...
                    <div className="border-l border-gray-100 pl-12 space-y-12">
                        ...
                        <div>
                            ...
                            <a href="mailto:connect@b-3solutions.com" className="font-body text-black text-lg hover:underline decoration-black decoration-2 underline-offset-4 block mb-2">
                                connect@b-3solutions.com
                            </a>
